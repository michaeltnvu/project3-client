  ...
  return (
    <div>
      <div className="flex flex-col items-center my-8">
        <h3 className="text-3xl mb-4 font-amarillo tracking-wider">Trending Posts</h3>
        ...
        <div className="flex flex-col items-center my-8">
        <h3 className="text-3xl mb-4 font-amarillo tracking-wider">Posts from other Pathfindrs</h3>
        <div className="flex flex-wrap justify-center gap-10">
          {posts &&
            otherPosts.map((post) => (
              <div
